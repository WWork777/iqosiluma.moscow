...
export async function generateMetadata({ params }) {
  ...
  return {
    ...
    alternates: {
      canonical: `https://iqosiluma.moscow//blog/${article.slug}`,
    },
    openGraph: {
      title: article.title,
      description: article.metaDescription || article.description,
      url: `https://iqosiluma.moscow//blog/${article.slug}`,
      type: "article",
...
export default function ArticlePage({ params }) {
    ...
    itemListElement: [
      {
        ...
        position: 1,
        name: "Главная",
        item: "https://iqosiluma.moscow/",
      },
      {
        "@type": "ListItem",
        position: 2,
        name: "Блог",
        item: "https://iqosiluma.moscow//blog",
      },
      {
        "@type": "ListItem",
        position: 3,
        name: article.title,
        item: `https://iqosiluma.moscow//blog/${article.slug}`,
      },
    ],
  };
  ...
  const articleSchema = {
    ...
    publisher: {
      ...
      logo: {
        "@type": "ImageObject",
        url: "https://iqosiluma.moscow//logo.png",
      },
    },
    mainEntityOfPage: {
      "@type": "WebPage",
      "@id": `https://iqosiluma.moscow//blog/${article.slug}`,
    },
  };
