...
async function fetchItems() {
  const res = await fetch("https://iqosiluma.moscow/api/products/getiqos", {
    cache: "no-store",
  });
...
export async function generateMetadata() {
  ...
  return {
    ...
    alternates: {
      canonical: `https://iqosiluma.moscow/products/iqosexclusive`,
    },
    openGraph: {
      ...
      url: `https://iqosiluma.moscow/products/iqosexclusive`,
      images: [
        {
