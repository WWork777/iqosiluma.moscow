...
export async function POST(req) {
  try {
    ...
    let subject = "Заявка с сайта iqosIluma.moscow";
    ...
    if (text.includes('НОВЫЙ КЛИЕНТ') || text.includes('🔥 НОВЫЙ КЛИЕНТ 🔥')) {
      subject = `🔥 НОВЫЙ КЛИЕНТ: ${customerName} - iqosIluma.moscow`;
    } else {
      subject = `Заявка от ${customerName} - iqosIluma.moscow`;
    }
        ...
        <body>
          <div class="email-container">
            <div class="email-header">
              <h2>Заявка с сайта iqosIluma.moscow</h2>
            </div>
            ...
            <div class="email-content">
              ...
              <div class="footer">
                <p>Отправлено с сайта iqosIluma.moscow</p>
    ...
    const mailOptions = {
      ...
      headers: {
        ...
        'X-Mailer': 'iqosIluma.moscow Contact Form'
      }
    };
